...
//
// Solidity: function getLiquidityPoolStorage(address liquidityPool) view returns(bool isSynced, (bool,bool,address[7],int256,int256,uint256[4],(uint8,address,int256[39],uint256,string,bool,int256,int256)[]) pool)
