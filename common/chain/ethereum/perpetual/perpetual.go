...
// FundingState is a paid mutator transaction binding the contract method 0xb25cdccf.
//
// Solidity: function fundingState() returns(int256 unitAccumulativeFunding, int256 fundingRate, uint256 fundingTime)
func (_Perpetual *PerpetualTransactor) FundingState(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Perpetual.contract.Transact(opts, "fundingState")
}

// FundingState is a paid mutator transaction binding the contract method 0xb25cdccf.
//
// Solidity: function fundingState() returns(int256 unitAccumulativeFunding, int256 fundingRate, uint256 fundingTime)
func (_Perpetual *PerpetualSession) FundingState() (*types.Transaction, error) {
	return _Perpetual.Contract.FundingState(&_Perpetual.TransactOpts)
}

// FundingState is a paid mutator transaction binding the contract method 0xb25cdccf.
//
// Solidity: function fundingState() returns(int256 unitAccumulativeFunding, int256 fundingRate, uint256 fundingTime)
func (_Perpetual *PerpetualTransactorSession) FundingState() (*types.Transaction, error) {
	return _Perpetual.Contract.FundingState(&_Perpetual.TransactOpts)
}
...
//
// Solidity: function state() returns(bool isEmergency, bool isShuttingdown, int256 insuranceFund, int256 donatedInsuranceFund, int256 markPrice, int256 indexPrice)
func (_Perpetual *PerpetualTransactor) State(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Perpetual.contract.Transact(opts, "state")
}

// State is a paid mutator transaction binding the contract method 0xc19d93fb.
//
// Solidity: function state() returns(bool isEmergency, bool isShuttingdown, int256 insuranceFund, int256 donatedInsuranceFund, int256 markPrice, int256 indexPrice)
func (_Perpetual *PerpetualSession) State() (*types.Transaction, error) {
	return _Perpetual.Contract.State(&_Perpetual.TransactOpts)
}

// State is a paid mutator transaction binding the contract method 0xc19d93fb.
//
// Solidity: function state() returns(bool isEmergency, bool isShuttingdown, int256 insuranceFund, int256 donatedInsuranceFund, int256 markPrice, int256 indexPrice)
func (_Perpetual *PerpetualTransactorSession) State() (*types.Transaction, error) {
	return _Perpetual.Contract.State(&_Perpetual.TransactOpts)
}
