...
func (_ERC20 *ERC20Caller) Whitelist(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var out []interface{}
...
//
// Solidity: function whitelist(address ) view returns(bool)
func (_ERC20 *ERC20Session) Whitelist(arg0 common.Address) (bool, error) {
...
//
// Solidity: function whitelist(address ) view returns(bool)
func (_ERC20 *ERC20CallerSession) Whitelist(arg0 common.Address) (bool, error) {
	return _ERC20.Contract.Whitelist(&_ERC20.CallOpts, arg0)
}
...
func (_ERC20 *ERC20Transactor) Burn(opts *bind.TransactOpts, _from common.Address, _value *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "burn", _from, _value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address _from, uint256 _value) returns()
func (_ERC20 *ERC20Session) Burn(_from common.Address, _value *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.Burn(&_ERC20.TransactOpts, _from, _value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address _from, uint256 _value) returns()
func (_ERC20 *ERC20TransactorSession) Burn(_from common.Address, _value *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.Burn(&_ERC20.TransactOpts, _from, _value)
}
...
func (_ERC20 *ERC20Transactor) DecreaseApproval(opts *bind.TransactOpts, _spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "decreaseApproval", _spender, _subtractedValue)
}

// DecreaseApproval is a paid mutator transaction binding the contract method 0x66188463.
//
// Solidity: function decreaseApproval(address _spender, uint256 _subtractedValue) returns(bool)
func (_ERC20 *ERC20Session) DecreaseApproval(_spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.DecreaseApproval(&_ERC20.TransactOpts, _spender, _subtractedValue)
}

// DecreaseApproval is a paid mutator transaction binding the contract method 0x66188463.
//
// Solidity: function decreaseApproval(address _spender, uint256 _subtractedValue) returns(bool)
func (_ERC20 *ERC20TransactorSession) DecreaseApproval(_spender common.Address, _subtractedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.DecreaseApproval(&_ERC20.TransactOpts, _spender, _subtractedValue)
}
...
func (_ERC20 *ERC20Transactor) IncreaseApproval(opts *bind.TransactOpts, _spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "increaseApproval", _spender, _addedValue)
}

// IncreaseApproval is a paid mutator transaction binding the contract method 0xd73dd623.
//
// Solidity: function increaseApproval(address _spender, uint256 _addedValue) returns(bool)
func (_ERC20 *ERC20Session) IncreaseApproval(_spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.IncreaseApproval(&_ERC20.TransactOpts, _spender, _addedValue)
}

// IncreaseApproval is a paid mutator transaction binding the contract method 0xd73dd623.
//
// Solidity: function increaseApproval(address _spender, uint256 _addedValue) returns(bool)
func (_ERC20 *ERC20TransactorSession) IncreaseApproval(_spender common.Address, _addedValue *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.IncreaseApproval(&_ERC20.TransactOpts, _spender, _addedValue)
}
...
//
// Solidity: function setWhitelist(address who, bool enable) returns()
func (_ERC20 *ERC20Transactor) SetWhitelist(opts *bind.TransactOpts, who common.Address, enable bool) (*types.Transaction, error) {
...
//
// Solidity: function setWhitelist(address who, bool enable) returns()
func (_ERC20 *ERC20Session) SetWhitelist(who common.Address, enable bool) (*types.Transaction, error) {
...
//
// Solidity: function setWhitelist(address who, bool enable) returns()
func (_ERC20 *ERC20TransactorSession) SetWhitelist(who common.Address, enable bool) (*types.Transaction, error) {
	return _ERC20.Contract.SetWhitelist(&_ERC20.TransactOpts, who, enable)
}
...
//
// Solidity: event Burn(address indexed _to, uint256 _value)
func (_ERC20 *ERC20Filterer) FilterBurn(opts *bind.FilterOpts, _to []common.Address) (*ERC20BurnIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "Burn", _toRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Burn(address indexed _to, uint256 _value)
func (_ERC20 *ERC20Filterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *ERC20Burn, _to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "Burn", _toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_ERC20 *ERC20Filterer) FilterMint(opts *bind.FilterOpts, _to []common.Address) (*ERC20MintIterator, error) {
	...
	logs, sub, err := _ERC20.contract.FilterLogs(opts, "Mint", _toRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Mint(address indexed _to, uint256 _value)
func (_ERC20 *ERC20Filterer) WatchMint(opts *bind.WatchOpts, sink chan<- *ERC20Mint, _to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ERC20.contract.WatchLogs(opts, "Mint", _toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
