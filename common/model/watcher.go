...
type Watcher struct {
	...
	SyncedBlockNumber  int64 `json:"syncedBlockNumber"  db:"synced_block_number"`
}

type SyncedBlock struct {
	WatcherID   int       `json:"watcherID"   db:"watcher_id"   primaryKey:"true" gorm:"primary_key"`
	BlockNumber int64     `json:"blockNumber" db:"block_number" primaryKey:"true" gorm:"primary_key"`
